...
function myFunction() {
     var res1="<tr><td><input type='text' name='' value=''placeholder='ادخل اسم الحدث'></td>"
     var res2 ="<td> <input type='Number' name='' value=''  class='input' placeholder='ادخل الفترة بالساعات'></td>"
